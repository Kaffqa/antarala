...
const islandInfos: Record<string, IslandInfo> = {
  ...
  Kalimantan: new IslandInfo(
    "Pulau Kalimantan",
    "Pulau Kalimantan adalah hamparan raksasa yang menyimpan napas hutan hujan tropis dan jejak peradaban sungai. Dari kerajaan Tanjungpura hingga jalur perdagangan kuno di tepian Mahakam.",
    "KALIMANTAN",
    "Pulau Kalimantan adalah pulau terbesar ketiga di dunia dan terletak di bagian tengah Indonesia, berbatasan langsung dengan Malaysia dan Brunei Darussalam. Dikenal sebagai “Pulau Seribu Sungai,” Kalimantan dilintasi garis khatulistiwa dan dikelilingi oleh Laut Jawa di selatan, Selat Karimata di barat, Selat Makassar di timur, serta Laut Sulawesi di utara.",
    "/daerah/asset/kalimantan/slide1.svg",
    "Keraton Kadriyah",
    "/daerah/asset/kalimantan/slide2.svg",
    "Tugu Soekarno",
    "/daerah/asset/kalimantan/slide3.svg",
    "Istana Kuning",
    "Pulau Kalimantan adalah bentang raksasa yang menjadi nadi hijau Indonesia, menyatukan hutan hujan tropis, sungai-sungai purba, dan jejak peradaban yang mengalir tenang. Di tengah lanskap yang dibelah oleh Mahakam, Kapuas, dan Barito, tumbuh budaya Dayak, Banjar, dan Kutai yang hidup berdampingan dengan alam."

  ),
  Bali: new IslandInfo(
    "Pulau Bali",
    "Pulau Bali adalah bentang spiritual yang menyimpan denyut laut, gunung, dan jiwa manusia. Dari kerajaan Gelgel hingga jejak perdagangan maritim di pesisir Sanur, Bali tumbuh dalam harmoni antara alam dan ritus.",
    "BALI",
    "Pulau Bali adalah pulau kecil di bagian tengah selatan Indonesia, terletak di antara Pulau Jawa dan Nusa Tenggara Barat. Dikelilingi oleh Selat Bali di barat, Selat Lombok di timur, Laut Bali di utara, dan Samudera Hindia di selatan, Bali menjadi simpul penting dalam jalur budaya dan spiritual Nusantara.",
    "/daerah/asset/bali/slide1.svg",
    "Puri Agung Jrokuta",
    "/daerah/asset/bali/slide2.svg",
    "Kertha Gosa",
    "/daerah/asset/bali/slide3.svg",
    "Bajra Sandhi",
    "Pulau Bali adalah bentang spiritual yang menjadi nadi budaya Indonesia, menyatukan laut yang berbisik, gunung yang menjulang, dan ritus yang mengakar dalam kehidupan sehari-hari. Di tengah lanskap yang ditatah oleh Gunung Agung, Sungai Ayung, dan pesisir Sanur, tumbuh budaya Bali yang hidup dalam harmoni antara manusia, alam, dan para dewa."

  ),
  Sulawesi: new IslandInfo(
    "Pulau Sulawesi",
    "Pulau Sulawesi adalah bentang bersayap yang menyimpan denyut peradaban di antara teluk-teluk dan semenanjung yang saling menjulur. Dari kerajaan Luwu, Ternate, hingga Toraja yang menatah batu menjadi rumah leluhur, Sulawesi tumbuh dalam lanskap yang tak pernah datar.",
    "SULAWESI",
    "Pulau Sulawesi terletak di bagian tengah Indonesia, membentang unik seperti huruf “K” dengan empat semenanjung yang menjulur ke berbagai arah. Bentuk geografisnya yang kompleks menjadikan Sulawesi sebagai simpul penting dalam jalur laut, ekosistem tropis, dan pertemuan budaya maritim di kawasan Asia Tenggara.",
    "/daerah/asset/sulawesi/slide1.svg",
    "Julang Sulawesi",
    "/daerah/asset/sulawesi/slide2.svg",
    "Tana Toraja",
    "/daerah/asset/sulawesi/slide3.svg",
    "Kuskus Beruang",
    "Pulau Sulawesi adalah rumah bagi ribuan spesies unik yang tak ditemukan di tempat lain.Bentuk geografisnya yang kompleks dan isolasi alamnya menjadikan Sulawesi sebagai salah satu pusat keanekaragaman hayati paling kaya di Indonesia."

  ),
  Papua: new IslandInfo(
    "Pulau Papua",
    "Papua adalah ruang yang tak hanya luas secara geografis, tapi juga dalam makna budaya. Dari lembah Baliem hingga pesisir Biak, dari tradisi bakar batu hingga tarian Cenderawasih, Papua tumbuh dalam ritme yang berbeda.",
    "PAPUA",
    "Pulau Papua adalah bentang raksasa di ujung timur Indonesia, tempat di mana pegunungan menjulang seperti tulang punggung bumi dan hutan hujan tropis menyimpan napas purba yang belum selesai diceritakan. Membentang dari barat ke timur, Papua berbatasan langsung dengan Papua Nugini dan dikelilingi oleh Laut Arafuru, Samudra Pasifik, dan Laut Banda.",
    "/daerah/asset/papua/slide1.svg",
    "Cendrawasih",
    "/daerah/asset/papua/slide2.svg",
    "Rumah Honai",
    "/daerah/asset/papua/slide3.svg",
    "Danau Sentani",
    "Papua adalah pulau terbesar kedua di dunia, yang dikenal memiliki keindahan alam yang luar biasa.dari pegunungan, hutan lebat, padang rumput, rawa-rawa, hingga pemandangan bawah laut yang menakjubkan, seperti Raja Ampat. "

  ),
  NTT: new IslandInfo(
    "Pulau NTT",
    "Nusa Tenggara Timur adalah gugusan pulau yang tak hanya kering secara lanskap, tapi justru subur dalam makna budaya. NTT tumbuh dalam ritme yang keras namun penuh makna.  ",
    "NTT",
    "Pulau-pulau di Nusa Tenggara Timur adalah gugusan karang dan tanah kering yang menari di antara Laut Flores dan Samudra Hindia. Membentang dari barat ke timur, NTT terdiri dari pulau-pulau besar seperti Flores, Sumba, Timor Barat, Alor, dan Lembata.",
    "/daerah/asset/ntt/slide1.svg",
    "Komodo",
    "/daerah/asset/ntt/slide2.svg",
    "Pantai Oetune",
    "/daerah/asset/ntt/slide3.svg",
    "Sasando",
    "Alat musik Nusa Tenggara Timur (NTT) meliputi Sasando, alat musik petik berdawai dari bambu dan daun lontar, serta Prere. Alat-alat musik ini tidak hanya berfungsi sebagai hiburan, tetapi juga memiliki makna mendalam dan peran penting dalam berbagai upacara adat dan tradisi masyarakat NTT. "

  ),
  NTB: new IslandInfo(
    "Pulau NTB",
    "Nusa Tenggara Barat adalah gugusan pulau yang tak hanya kaya secara alam, tapi juga dalam lapisan makna budaya. Di sini, adat bukan sekadar warisan, tapi cara hidup yang menyatu dengan tanah, air, dan langit.",
    "NTB",
    "Pulau-pulau di Nusa Tenggara Barat adalah bentang tropis yang membelah Laut Jawa dan Samudra Hindia, terdiri dari dua pulau utama: Lombok di barat dan Sumbawa di timur, serta ratusan pulau kecil yang mengintari garis pantainya.",
    "/daerah/asset/ntb/slide1.svg",
    "Celupak Rinjani",
    "/daerah/asset/ntb/slide2.svg",
    "Anjungan NTB",
    "/daerah/asset/ntb/slide3.svg",
    "Pantai Mawun",
    "Pantai-pantai di Nusa Tenggara Barat (NTB) adalah lanskap tropis yang menyimpan keindahan yang beragam dan karakteristik unik. Terbentang di dua pulau utama—Lombok dan Sumbawa, pantai-pantai NTB bukan hanya tempat wisata, tapi juga ruang budaya, olahraga, dan spiritualitas lokal."
