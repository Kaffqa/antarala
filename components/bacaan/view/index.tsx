...
const Artikel = ({
  ...
  // Efek untuk scroll ke bagian yang ditentukan oleh hash URL
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      if (hash) {
        ...
        if (element) {
          // Tunggu sedikit sebelum scroll untuk memastikan semua elemen telah dirender
          setTimeout(() => {
  ...
  return (
    <section className="w-full overflow-x-hidden">
      {/* Situs */}
      <div id="situs" className="p-8 py-32 md:p-16 lg:p-24 bg-[#F2EDDA] text-[#676F59] xl:p-32 flex flex-col-reverse xl:flex-row items-center justify-center xl:gap-16">
      ...
      {/* Tradisi */}
      <div id="tradisi" className="text-[#F2EDDA] p-8 py-32 md:p-16 min-h-screen relative gap-16 lg:p-24 bg-[#242D17] xl:p-32 flex flex-col items-center justify-center">
      ...
      {/* Makanan */}
      <div id="makanan" className="p-8 py-32 md:p-16 lg:p-24 bg-[#F2EDDA] text-[#676F59] relative xl:p-32 flex flex-col-reverse xl:flex-row-reverse items-center justify-center xl:gap-16">
